...
def gen_charts():
    ...
    ax = sns.histplot(data=task2_data, x="5", cumulative=True, bins=6, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
    plt.savefig("charts/5.png")
    plt.clf()
    ax = sns.histplot(data=task2_data, x="10", cumulative=True, bins=11, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
    plt.savefig("charts/10.png")
    plt.clf()
    ax = sns.histplot(data=task2_data, x="15", cumulative=True, bins=16, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
    plt.savefig("charts/15.png")
    plt.clf()
    ax = sns.histplot(data=task2_data, x="20", cumulative=True, bins=21, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
    plt.savefig("charts/20.png")
    plt.clf()
    ax = sns.histplot(data=task2_data, x="25", cumulative=True, bins=26, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
    plt.savefig("charts/25.png")
    plt.clf()
    ax = sns.histplot(data=task2_data, x="30", cumulative=True, bins=31, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
    plt.savefig("charts/30.png")
    plt.clf()
    ax = sns.histplot(data=task2_data, x="100", cumulative=True, bins=31, stat="probability")
    x0, x1 = ax.get_xlim() 
    x = np.linspace(x0, x1, 250)
    y = stats.norm.cdf(x)
    ax.plot(x, y, 'r')
